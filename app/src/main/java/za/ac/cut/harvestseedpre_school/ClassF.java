...
public class ClassF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class_f);
        ReuseClass.setSupportActionBarView(this, "View Class F").setIcon(R.mipmap.ic_launcher);
        lvUsers = (ListView) findViewById(R.id.lst_classF);
    ...
    private void OnClicks() {
        ...
        lvUsers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent1 = new Intent(ClassF.this, LearnerInformation.class);
    ...
    public void loadData() {
        ...
        String whereClause = "className = 'Class F'";
