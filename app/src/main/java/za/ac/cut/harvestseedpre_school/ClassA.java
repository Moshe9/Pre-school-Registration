...
public class ClassA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReuseClass.setSupportActionBarView(this, "View Class A").setIcon(R.mipmap.ic_launcher);
        lvUsers = (ListView) findViewById(R.id.lst_classA);
    ...
    private void OnClicks() {
        ...
        lvUsers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent1 = new Intent(ClassA.this, LearnerInformation.class);
                ...
                intent1.putExtra("idNumber",String.valueOf(usersList.get(position).getIdNumber()));
    ...
    public void loadData() {
        ...
        String whereClause = "className = 'Class A'";
