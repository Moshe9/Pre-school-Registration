...
public class ClassD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class_d);
        ReuseClass.setSupportActionBarView(this, "View Class D").setIcon(R.mipmap.ic_launcher);
        lvUsers = (ListView) findViewById(R.id.lst_classD);
    ...
    private void OnClicks() {
        ...
        lvUsers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent1 = new Intent(ClassD.this, LearnerInformation.class);
    ...
    public void loadData() {
        ...
        String whereClause = "className = 'Class D'";
