...
public class ClassE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReuseClass.setSupportActionBarView(this, "View Class E").setIcon(R.mipmap.ic_launcher);
        lvUsers = (ListView) findViewById(R.id.lst_classE);
    ...
    private void OnClicks() {
        ...
        lvUsers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent1 = new Intent(ClassE.this, LearnerInformation.class);
    ...
    public void loadData() {
        ...
        String whereClause = "className = 'Class E'";
